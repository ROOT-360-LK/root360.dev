      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-3xl text-lg text-zinc-600 dark:text-zinc-400">
            Ready to transform your business with technology? Reach out to us and let&apos;s 
              ...
              <div className="space-y-6">
                {contactInfo.map((item, index) => (
                  ...
                  >
                    ...
                    <div>
                      <div className="font-medium text-green-100">{item.title}</div>
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <p className="text-xs text-zinc-500 text-center">
                    ...
                    {" "}and{" "}
                    <a href="#" className="underline hover:text-green-500">Terms of Service</a>.
                  </p>
                </form>
              )}
            </CardContent>
